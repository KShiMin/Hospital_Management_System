...
public class Billing {
     ...
     */
    public Billing(int discount, Patient patient) {
    ...
    /**
     * Set the taxRate by calculating it based on the patient's nationality
     * 
     * @param nationality The nationality of the patient.
     */
    public void calculateTaxRate(String nationality) {
        this.taxRate = (nationality.equals("Singaporean") || nationality.equals("Permanent Resident")) ? 0 : 9;
    }

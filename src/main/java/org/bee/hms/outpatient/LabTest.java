...
public class LabTest {
     ...
     * @param doctor the doctor associated with the lab test.
     * @param remarks remarks or comments regarding the lab test.
     * @param cost the cost of the lab test.
     */
    public LabTest(LABTYPE type, Date dateStamp, STATUS status, OutpatientCase outpatientCase,
     ...
     *
     * @param doctor the physician to set.
     */

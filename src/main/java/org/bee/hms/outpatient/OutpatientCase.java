...
public class OutpatientCase {
    ...
    public String toString() {
        ...
        stringBuilder.append(
                String.format("Doctor ID:         %s\n", (doctor != null ? doctor.getMcr() : "N/A")));
     ...
     * @param doctor             The doctor handling the case.
    ...
    public OutpatientCase(Date appointmentDate, String medicalHistory,
                          CASETYPE type, STATUS status, DEPARTMENT department, String diagnosis,
                          String visitReason, ArrayList<Drug> currentMedications, ArrayList<Drug> prescriptions,
                          Date followUpDate, String instructions, Patient patient, Doctor doctor, Billing billing,
    ...
    public void displayOutpatientCaseInfo() {
        ...
        System.out.println("Assigned Doctor ID: " + this.doctor.getMcr());
        System.out.println("Assigned Doctor Name: " + this.doctor.getName());
    ...
    /**
     * Retrieves the doctor associated with this outpatient case.
     *
    ...
    /**
     * Sets the doctor for this outpatient case.
     *
    ...
    /**
     * Retrieves all outpatient cases assigned to a specific doctor.
     *
     * @param doctor The physician whose cases are to be retrieved.
     * @return A list of outpatient cases associated with the given doctor.
     */
    public static List<OutpatientCase> getAllCasesByDoctor(Doctor doctor) {
        List<OutpatientCase> allOutpatientCases = new ArrayList<>();
        for (OutpatientCase i : instances) {
            if (i.getDoctor().equals(physician)) {

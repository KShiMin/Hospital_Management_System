...
public class OutpatientCase {
    ...
    /** List of Feedbacks provided by Patient */
    ...
    public String toString() {
        ...
        stringBuilder.append(String.format("Outpatient Date:     %s\n", outpatientDate));
     ...
     * 
     * @param outpatientDate    Date of the appointment.
     ...
     */
    public OutpatientCase(Date outpatientDate, Department department, String diagnosis,  ArrayList<Drug> prescriptions,
            Date followUpDate, String instructions, Patient patient, Physician physician,
            ArrayList<Treatment> treatments, ArrayList<LabTest> labtests, ArrayList<Feedback> feedbacks) {
    ...
    public void displayOutpatientCaseInfo() {
        ...
        System.out.println("Appointment Date: " + this.outpatientDate);
    ...
    /**
     * Retrieves the Outpatient's date.
     * 

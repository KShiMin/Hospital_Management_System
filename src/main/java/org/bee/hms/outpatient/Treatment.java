...
public class Treatment {
    ...
    public void setOutpatientCase(OutpatientCase outpatientCase) {
        if (this.outpatientCase != null) {
            this.outpatientCase.removeTreatment(this);
        }
        this.outpatientCase = outpatientCase;
        outpatientCase.addTreatment(this);
    }
    ...
    */
     ...
     *
     * @param outpatientCase the outpatient case for which treatments are to be retrieved.
     * @return a list of treatments linked to the given outpatient case.
     */
    public static List<Treatment> getAllTreatmentsByCase(OutpatientCase outpatientCase) {
        List<Treatment> allTreatments = new ArrayList<>();
        for (Treatment i : instances) {
            if (i.getOutpatientCase().equals(outpatientCase)) {
                allTreatments.add(i);
            }
        }
